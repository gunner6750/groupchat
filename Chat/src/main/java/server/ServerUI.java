...
public class ServerUI extends javax.swing.JFrame {
          ...
          try{
			 while(!serverSocket.isClosed()){
				 ...
				 ClientHandler clientHandler = new ClientHandler(socket);
                                 String name;
                                 name = clientHandler.getName();
                                 
                                 names.setText(clientHandler.listingClient());
                                 clients.setText(String.valueOf(clientHandler.numberOfClients()));
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        server.closerServer();
        numberOfClients=0;
        clients.setText(String.valueOf(numberOfClients));
        names.setText("");
